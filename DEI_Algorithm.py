...
def inclusion(csv):
    ...
    if fem_avg_satisf < male_avg_satisf:
        ...
        print("Your employees seem to be equally satisfied regarless of gender, but look at the box and whisker plot we've provided for you to see if you can improve satisfaction as a whole.")
    ...
    if fem_avg_engage < male_avg_engage:
        ...
        print("Your male employees seem to be less engaged than their male counterparts. It's important for all employees to feel comfortable speaking up, and lower engagement from a specific group will reduce innovation. Check out our Solutions Tab to solve this problem!")
        inclusion_score = inclusion_score - 1
    else:
